...
func main() {
	...
	fence, _, err := info.Loader.CreateFence(info.Device, nil, core1_0.FenceCreateOptions{})
	if err != nil {
		log.Fatalln(err)
	}
	...
	event, _, err := info.Loader.CreateEvent(info.Device, nil, core1_0.EventCreateOptions{})
	if err != nil {
		log.Fatalln(err)
	}
